...
public class Loader {
	...
	public static RawModel loadToVAO(float[] positions, float[] textureCoords, float[] normals, int[] indices, List<Vertex> vertices) {
	...
	public int loadCubeMap(String[] textureFiles) {
		...
		for (int i = 0; i < textureFiles.length; i++) {
			...
			TextureData data = decodeTextureFile("resources/images/skybox/" + textureFiles[i] + ".png");
